...
p1 = ggplot(DPH_acute_0_50, aes(x = time_min,
  ...
  ggtitle("DPH acute exposure for covered top") +
  theme_classic()+
  labs(fill = "Treatment") +
...
p2 = ggplot(DPH_acute_50_100, aes(x = time_min,
  ...
  geom_boxplot(alpha = 0.8) +
  labs(x = "Treatment", y = "Proportion of copepods") +
  ggtitle("DPH acute exposure for covered bottom") +
  theme_classic()+
  labs(fill = "Treatment") +
  scale_fill_manual(labels = c("Control", "Environmentally relevant", "High"), values = c("skyblue1", "palegreen3", "firebrick1"))
...
p3 = ggplot(DPH_chronic_0_50, aes(x = time_min,
  ...
  geom_boxplot(alpha = 0.8) +
  labs(x = "Treatment", y = "Proportion of copepods") +
  ggtitle("DPH chronic exposure for covered top") +
  theme_classic()+
  labs(fill = "Treatment") +
  scale_fill_manual(labels = c("Control", "Environmentally relevant", "High"), values = c("skyblue1", "palegreen3", "firebrick1"))
...
p4 = ggplot(DPH_chronic_50_100, aes(x = time_min,
  ...
  geom_boxplot(alpha = 0.8) +
  labs(x = "Treatment", y = "Proportion of copepods") +
  ggtitle("DPH chronic exposure for covered bottom") +
  theme_classic()+
  labs(fill = "Treatment") +
  scale_fill_manual(labels = c("Control", "Environmentally relevant", "High"), values = c("skyblue1", "palegreen3", "firebrick1"))
...
p5 = ggplot(lorazepam_acute_0_50, aes(x = time_min,
  ...
  geom_boxplot(alpha = 0.8) +
  labs(x = "Treatment", y = "Proportion of copepods") +
  ggtitle("Lorazepam acute exposure for covered top") +
  theme_classic()+
  labs(fill = "Treatment") +
  scale_fill_manual(labels = c("Control", "Environmentally relevant", "High"), values = c("skyblue1", "palegreen3", "firebrick1"))
...
p6 = ggplot(lorazepam_acute_50_100, aes(x = time_min,
  ...
  geom_boxplot(alpha = 0.8) +
  labs(x = "Treatment", y = "Proportion of copepods") +
  ggtitle("Lorazepam acute exposure for covered bottom") +
  theme_classic()+
  labs(fill = "Treatment") +
  scale_fill_manual(labels = c("Control", "Environmentally relevant", "High"), values = c("skyblue1", "palegreen3", "firebrick1"))
